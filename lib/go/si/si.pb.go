...
func (EventRecord_Type) EnumDescriptor() ([]byte, []int) {
	return file_yunikorn_scheduler_interface_si_proto_rawDescGZIP(), []int{34, 0}
}
...
func (EventRecord_ChangeType) EnumDescriptor() ([]byte, []int) {
	return file_yunikorn_scheduler_interface_si_proto_rawDescGZIP(), []int{34, 1}
}
...
const (
	...
	EventRecord_QUEUE_PREEMPTION    EventRecord_ChangeDetail = 407 // Quota Preemption
...
func (EventRecord_ChangeDetail) EnumDescriptor() ([]byte, []int) {
	return file_yunikorn_scheduler_interface_si_proto_rawDescGZIP(), []int{34, 2}
}
...
func (x *BindingArgs) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BindingArgs) ProtoMessage() {}

func (x *BindingArgs) ProtoReflect() protoreflect.Message {
	mi := &file_yunikorn_scheduler_interface_si_proto_msgTypes[27]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BindingArgs.ProtoReflect.Descriptor instead.
func (*BindingArgs) Descriptor() ([]byte, []int) {
	return file_yunikorn_scheduler_interface_si_proto_rawDescGZIP(), []int{27}
}

func (x *BindingArgs) GetAllocationKey() string {
	if x != nil {
		return x.AllocationKey
	}
	return ""
...
func (x *BindingArgs) GetNodeID() string {
	if x != nil {
		return x.NodeID
	}
	return ""
...
func (x *BindingResponse) GetSuccess() bool {
	if x != nil {
		return x.Success
	}
	return false
...
func (x *BindingResponse) GetReason() string {
	if x != nil {
		return x.Reason
	}
	return ""
...
const file_yunikorn_scheduler_interface_si_proto_rawDesc = "" +
	"\n" +
	"%yunikorn-scheduler-interface/si.proto\x12\x05si.v1\x1a google/protobuf/descriptor.proto\"\xb4\x03\n" +
	...
	"\tbuildInfo\x18\x04 \x03(\v24.si.v1.RegisterResourceManagerRequest.BuildInfoEntryR\tbuildInfo\x12\x16\n" +
	"\x06config\x18\x05 \x01(\tR\x06config\x12X\n" +
	"\vextraConfig\x18\x06 \x03(\v26.si.v1.RegisterResourceManagerRequest.ExtraConfigEntryR\vextraConfig\x1a<\n" +
	...
	"\breleases\x18\x02 \x01(\v2 .si.v1.AllocationReleasesRequestR\breleases\x12\x12\n" +
	"\x04rmID\x18\x03 \x01(\tR\x04rmID\x123\n" +
	"\vallocations\x18\x04 \x03(\v2\x11.si.v1.AllocationR\vallocationsJ\x04\b\x01\x10\x02R\x04asks\"\x91\x01\n" +
	"\x12ApplicationRequest\x12.\n" +
	"\x03new\x18\x01 \x03(\v2\x1c.si.v1.AddApplicationRequestR\x03new\x127\n" +
	"\x06remove\x18\x02 \x03(\v2\x1f.si.v1.RemoveApplicationRequestR\x06remove\x12\x12\n" +
	...
	"\breleased\x18\x02 \x03(\v2\x18.si.v1.AllocationReleaseR\breleased\x12K\n" +
	"\x13rejectedAllocations\x18\x05 \x03(\v2\x19.si.v1.RejectedAllocationR\x13rejectedAllocationsJ\x04\b\x03\x10\x04J\x04\b\x04\x10\x05R\freleasedAsksR\brejected\"\xba\x01\n" +
	"\x13ApplicationResponse\x126\n" +
	"\brejected\x18\x01 \x03(\v2\x1a.si.v1.RejectedApplicationR\brejected\x126\n" +
	"\baccepted\x18\x02 \x03(\v2\x1a.si.v1.AcceptedApplicationR\baccepted\x123\n" +
	"\aupdated\x18\x03 \x03(\v2\x19.si.v1.UpdatedApplicationR\aupdated\"p\n" +
	"\fNodeResponse\x12/\n" +
	"\brejected\x18\x01 \x03(\v2\x13.si.v1.RejectedNodeR\brejected\x12/\n" +
	"\baccepted\x18\x02 \x03(\v2\x13.si.v1.AcceptedNodeR\baccepted\"\xa6\x01\n" +
	"\x12UpdatedApplication\x12$\n" +
	"\rapplicationID\x18\x01 \x01(\tR\rapplicationID\x12\x14\n" +
	"\x05state\x18\x02 \x01(\tR\x05state\x12:\n" +
	"\x18stateTransitionTimestamp\x18\x03 \x01(\x03R\x18stateTransitionTimestamp\x12\x18\n" +
	...
	"\bResource\x12<\n" +
	"\tresources\x18\x01 \x03(\v2\x1e.si.v1.Resource.ResourcesEntryR\tresources\x1aM\n" +
	...
	"\x11allowPreemptOther\x18\x02 \x01(\bR\x11allowPreemptOther\"\xd4\x03\n" +
	...
	"\x03ugi\x18\x04 \x01(\v2\x1b.si.v1.UserGroupInformationR\x03ugi\x12:\n" +
	"\x04tags\x18\x05 \x03(\v2&.si.v1.AddApplicationRequest.TagsEntryR\x04tags\x12B\n" +
	"\x1cexecutionTimeoutMilliSeconds\x18\x06 \x01(\x03R\x1cexecutionTimeoutMilliSeconds\x127\n" +
	"\x0eplaceholderAsk\x18\a \x01(\v2\x0f.si.v1.ResourceR\x0eplaceholderAsk\x120\n" +
	...
	"\x0eallocationTags\x18\x02 \x03(\v2%.si.v1.Allocation.AllocationTagsEntryR\x0eallocationTags\x12;\n" +
	"\x10resourcePerAlloc\x18\x05 \x01(\v2\x0f.si.v1.ResourceR\x10resourcePerAlloc\x12\x1a\n" +
	...
	"originator\x12C\n" +
	"\x10preemptionPolicy\x18\x0f \x01(\v2\x17.si.v1.PreemptionPolicyR\x10preemptionPolicy\x1aA\n" +
	"\x13AllocationTagsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01J\x04\b\a\x10\bJ\x04\b\x03\x10\x04J\x04\b\r\x10\x0eR\tqueueNameR\x04UUIDR\fallocationID\"\x88\x01\n" +
	"\x19AllocationReleasesRequest\x12L\n" +
	"\x14allocationsToRelease\x18\x01 \x03(\v2\x18.si.v1.AllocationReleaseR\x14allocationsToReleaseJ\x04\b\x02\x10\x03R\x17allocationAsksToRelease\"\x81\x02\n" +
	"\x11AllocationRelease\x12$\n" +
	"\rpartitionName\x18\x01 \x01(\tR\rpartitionName\x12$\n" +
	"\rapplicationID\x18\x02 \x01(\tR\rapplicationID\x12@\n" +
	"\x0fterminationType\x18\x04 \x01(\x0e2\x16.si.v1.TerminationTypeR\x0fterminationType\x12\x18\n" +
	"\amessage\x18\x05 \x01(\tR\amessage\x12$\n" +
	"\rallocationKey\x18\x06 \x01(\tR\rallocationKeyJ\x04\b\x03\x10\x04J\x04\b\a\x10\bR\x04UUIDR\fallocationID\"\xe0\x03\n" +
	"\bNodeInfo\x12\x16\n" +
	"\x06nodeID\x18\x01 \x01(\tR\x06nodeID\x124\n" +
	"\x06action\x18\x02 \x01(\x0e2\x1c.si.v1.NodeInfo.ActionFromRMR\x06action\x12?\n" +
	"\n" +
	"attributes\x18\x03 \x03(\v2\x1f.si.v1.NodeInfo.AttributesEntryR\n" +
	"attributes\x12A\n" +
	"\x13schedulableResource\x18\x04 \x01(\v2\x0f.si.v1.ResourceR\x13schedulableResource\x1a=\n" +
	...
	"\vBindingArgs\x12$\n" +
	"\rallocationKey\x18\x01 \x01(\tR\rallocationKey\x12\x16\n" +
	"\x06nodeID\x18\x02 \x01(\tR\x06nodeID\"N\n" +
	...
	"\x03key\x18\x01 \x01(\tR\x03key\x12\"\n" +
	"\x05value\x18\x02 \x01(\v2\f.si.v1.EmptyR\x05value:\x028\x01\"C\n" +
	"\x0fBindingResponse\x12\x18\n" +
	...
	"\x05state\x18\x03 \x01(\x0e2<.si.v1.UpdateContainerSchedulingStateRequest.SchedulingStateR\x05state\x12\x16\n" +
	...
	"\vextraConfig\x18\x05 \x03(\v22.si.v1.UpdateConfigurationRequest.ExtraConfigEntryR\vextraConfig\x1a>\n" +
	"\x10ExtraConfigEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01J\x04\b\x01\x10\x02R\aconfigs\"\xde\v\n" +
	"\vEventRecord\x12+\n" +
	"\x04type\x18\x01 \x01(\x0e2\x17.si.v1.EventRecord.TypeR\x04type\x12\x1a\n" +
	"\bobjectID\x18\x02 \x01(\tR\bobjectID\x12\x18\n" +
	"\amessage\x18\x05 \x01(\tR\amessage\x12$\n" +
	"\rtimestampNano\x18\x06 \x01(\x03R\rtimestampNano\x12G\n" +
	"\x0feventChangeType\x18\a \x01(\x0e2\x1d.si.v1.EventRecord.ChangeTypeR\x0feventChangeType\x12M\n" +
	"\x11eventChangeDetail\x18\b \x01(\x0e2\x1f.si.v1.EventRecord.ChangeDetailR\x11eventChangeDetail\x12 \n" +
	...
	"\tsi_secret\x12\x1d.google.protobuf.FieldOptions\x18\xa3\b \x01(\bR\bsiSecretB\vZ\tlib/go/sib\x06proto3"
...
var file_yunikorn_scheduler_interface_si_proto_msgTypes = make([]protoimpl.MessageInfo, 43)
var file_yunikorn_scheduler_interface_si_proto_goTypes = []any{
	...
	(*BindingArgs)(nil),                           // 33: si.v1.BindingArgs
	(*PreemptionPredicatesResponse)(nil),          // 34: si.v1.PreemptionPredicatesResponse
	(*Empty)(nil),                                 // 35: si.v1.Empty
	(*PreFilterPredicatesResponse)(nil),           // 36: si.v1.PreFilterPredicatesResponse
	(*BindingResponse)(nil),                       // 37: si.v1.BindingResponse
	...
	nil,                                           // 41: si.v1.RegisterResourceManagerRequest.BuildInfoEntry
	nil,                                           // 42: si.v1.RegisterResourceManagerRequest.ExtraConfigEntry
	nil,                                           // 43: si.v1.Resource.ResourcesEntry
	nil,                                           // 44: si.v1.AddApplicationRequest.TagsEntry
	nil,                                           // 45: si.v1.Allocation.AllocationTagsEntry
	nil,                                           // 46: si.v1.NodeInfo.AttributesEntry
	nil,                                           // 47: si.v1.PreFilterPredicatesResponse.FeasibleNodesEntry
	nil,                                           // 48: si.v1.UpdateConfigurationRequest.ExtraConfigEntry
...
var file_yunikorn_scheduler_interface_si_proto_depIdxs = []int32{
	41, // 0: si.v1.RegisterResourceManagerRequest.buildInfo:type_name -> si.v1.RegisterResourceManagerRequest.BuildInfoEntry
	42, // 1: si.v1.RegisterResourceManagerRequest.extraConfig:type_name -> si.v1.RegisterResourceManagerRequest.ExtraConfigEntry
	...
	43, // 15: si.v1.Resource.resources:type_name -> si.v1.Resource.ResourcesEntry
	24, // 16: si.v1.AddApplicationRequest.ugi:type_name -> si.v1.UserGroupInformation
	44, // 17: si.v1.AddApplicationRequest.tags:type_name -> si.v1.AddApplicationRequest.TagsEntry
	19, // 18: si.v1.AddApplicationRequest.placeholderAsk:type_name -> si.v1.Resource
	45, // 19: si.v1.Allocation.allocationTags:type_name -> si.v1.Allocation.AllocationTagsEntry
	...
	46, // 25: si.v1.NodeInfo.attributes:type_name -> si.v1.NodeInfo.AttributesEntry
	19, // 26: si.v1.NodeInfo.schedulableResource:type_name -> si.v1.Resource
	47, // 27: si.v1.PreFilterPredicatesResponse.FeasibleNodes:type_name -> si.v1.PreFilterPredicatesResponse.FeasibleNodesEntry
	...
	48, // 29: si.v1.UpdateConfigurationRequest.extraConfig:type_name -> si.v1.UpdateConfigurationRequest.ExtraConfigEntry
	...
	35, // 35: si.v1.PreFilterPredicatesResponse.FeasibleNodesEntry.value:type_name -> si.v1.Empty
	49, // 36: si.v1.si_secret:extendee -> google.protobuf.FieldOptions
