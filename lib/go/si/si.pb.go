...
type UpdateConfigRequest struct {
	...
	//	*UpdateConfigRequest_AddQueue
	//	*UpdateConfigRequest_DeleteQueue
	//	*UpdateConfigRequest_UpdateQueue
	UpdateRequest        isUpdateConfigRequest_UpdateRequest `protobuf_oneof:"updateRequest"`
	XXX_NoUnkeyedLiteral struct{}                            `json:"-"`
	XXX_unrecognized     []byte                              `json:"-"`
	XXX_sizecache        int32                               `json:"-"`
}
...
type isUpdateConfigRequest_UpdateRequest interface {
	isUpdateConfigRequest_UpdateRequest()
}

type UpdateConfigRequest_AddQueue struct {
	AddQueue *AddQueueRequest `protobuf:"bytes,1,opt,name=addQueue,proto3,oneof"`
}

type UpdateConfigRequest_DeleteQueue struct {
	DeleteQueue *DeleteQueueRequest `protobuf:"bytes,2,opt,name=deleteQueue,proto3,oneof"`
}

type UpdateConfigRequest_UpdateQueue struct {
	UpdateQueue *UpdateQueueRequest `protobuf:"bytes,3,opt,name=updateQueue,proto3,oneof"`
}

func (*UpdateConfigRequest_AddQueue) isUpdateConfigRequest_UpdateRequest() {}

func (*UpdateConfigRequest_DeleteQueue) isUpdateConfigRequest_UpdateRequest() {}

func (*UpdateConfigRequest_UpdateQueue) isUpdateConfigRequest_UpdateRequest() {}

func (m *UpdateConfigRequest) GetUpdateRequest() isUpdateConfigRequest_UpdateRequest {
	if m != nil {
...
func (m *UpdateConfigRequest) GetAddQueue() *AddQueueRequest {
	if x, ok := m.GetUpdateRequest().(*UpdateConfigRequest_AddQueue); ok {
		return x.AddQueue
	}
	return nil
}

func (m *UpdateConfigRequest) GetDeleteQueue() *DeleteQueueRequest {
	if x, ok := m.GetUpdateRequest().(*UpdateConfigRequest_DeleteQueue); ok {
		return x.DeleteQueue
	}
	return nil
}

func (m *UpdateConfigRequest) GetUpdateQueue() *UpdateQueueRequest {
	if x, ok := m.GetUpdateRequest().(*UpdateConfigRequest_UpdateQueue); ok {
...
// XXX_OneofWrappers is for the internal use of the proto package.
func (*UpdateConfigRequest) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		(*UpdateConfigRequest_AddQueue)(nil),
		(*UpdateConfigRequest_DeleteQueue)(nil),
		(*UpdateConfigRequest_UpdateQueue)(nil),
	}
}
...
func (m *UpdateConfigResponse) GetMessage() string {
	if m != nil {
		return m.Message
	}
	return ""
...
type AddQueueRequest struct {
	...
	FullQualitiedName string `protobuf:"bytes,2,opt,name=fullQualitiedName,proto3" json:"fullQualitiedName,omitempty"`
	// queue properties
	Properties map[string]string `protobuf:"bytes,3,rep,name=properties,proto3" json:"properties,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	// guaranteed resources
	MinQueueResource *Resource `protobuf:"bytes,4,opt,name=minQueueResource,proto3" json:"minQueueResource,omitempty"`
	// max resources
	MaxQueueResource     *Resource `protobuf:"bytes,5,opt,name=maxQueueResource,proto3" json:"maxQueueResource,omitempty"`
	XXX_NoUnkeyedLiteral struct{}  `json:"-"`
	XXX_unrecognized     []byte    `json:"-"`
	XXX_sizecache        int32     `json:"-"`
}
...
func (m *AddQueueRequest) GetQueueName() string {
	if m != nil {
		return m.QueueName
	}
	return ""
...
func (m *AddQueueRequest) GetFullQualitiedName() string {
	if m != nil {
		return m.FullQualitiedName
	}
	return ""
}

func (m *AddQueueRequest) GetProperties() map[string]string {
	if m != nil {
		return m.Properties
	}
	return nil
...
func (m *AddQueueRequest) GetMinQueueResource() *Resource {
	if m != nil {
		return m.MinQueueResource
	}
	return nil
}

func (m *AddQueueRequest) GetMaxQueueResource() *Resource {
	if m != nil {
		return m.MaxQueueResource
	}
	return nil
}
...
func (m *DeleteQueueRequest) GetFullQualitiedName() string {
	if m != nil {
		return m.FullQualitiedName
	}
	return ""
...
func (m *UpdateQueueRequest) GetQueueName() string {
	if m != nil {
		return m.QueueName
	}
	return ""
...
func (m *UpdateQueueRequest) GetFullQualitiedName() string {
	if m != nil {
		return m.FullQualitiedName
	}
	return ""
...
func (m *UpdateQueueRequest) GetProperties() map[string]string {
	if m != nil {
		return m.Properties
	}
	return nil
...
func (m *UpdateQueueRequest) GetMinQueueResource() *Resource {
	if m != nil {
		return m.MinQueueResource
	}
	return nil
...
func (m *UpdateQueueRequest) GetMaxQueueResource() *Resource {
	if m != nil {
		return m.MaxQueueResource
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*UpdateConfigRequest)(nil), "si.v1.UpdateConfigRequest")
	proto.RegisterType((*UpdateConfigResponse)(nil), "si.v1.UpdateConfigResponse")
	proto.RegisterType((*AddQueueRequest)(nil), "si.v1.AddQueueRequest")
	proto.RegisterMapType((map[string]string)(nil), "si.v1.AddQueueRequest.PropertiesEntry")
	proto.RegisterType((*DeleteQueueRequest)(nil), "si.v1.DeleteQueueRequest")
	proto.RegisterType((*UpdateQueueRequest)(nil), "si.v1.UpdateQueueRequest")
	proto.RegisterMapType((map[string]string)(nil), "si.v1.UpdateQueueRequest.PropertiesEntry")
...
var fileDescriptor_bcd2636ebca16c8c = []byte{
	...
	,
}
