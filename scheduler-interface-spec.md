...
message NodeInfo {
  ...
  // RackName of node, the node must exist to be updated
  string rackName = 2;

  // Action to perform by the scheduler
  ActionFromRM action = 3;
  ...
  Resource schedulableResource = 5;
